...
DEFN_SYSCALL3(36, int,       process_sigmap, uint32_t, uint32_t, void *)
DEFN_SYSCALL2(37, int,       process_sigsend, uint32_t, uint32_t)
DEFN_SYSCALL3(38, int,       process_info, uint32_t, int, void *)
DEFN_SYSCALL2(39, int,       process_list_all, uint32_t *, int)

DEFN_SYSCALL2(40, int,       pok_load, char *, uint32_t)
DEFN_SYSCALL1(41, int,       pok_unload, uint32_t)

DEFN_SYSCALL2(42, void *,    scuba_generate, void *, uint32_t)
DEFN_SYSCALL3(43, int,       scuba_map, void *, void *, int)
DEFN_SYSCALL1(44, int,       scuba_unmap, void *)
DEFN_SYSCALL1(45, void *,    scuba_phys, void *)
